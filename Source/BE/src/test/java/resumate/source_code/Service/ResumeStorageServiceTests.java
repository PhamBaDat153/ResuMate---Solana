...
class ResumeStorageServiceTests {
    ...
    void returnsStableUploadMetadataAndSha256() {
        CloudinaryUploadClient client = (bytes, folder) -> new CloudinaryUploadClient.CloudinaryAsset(
